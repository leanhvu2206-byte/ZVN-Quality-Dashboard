...
def bar_chart(series: pd.Series, color: str, total: float) -> go.Figure:
    ...
    layout(fig, 430, dict(l=52, r=155, t=22, b=62))
    fig.update_layout(showlegend=False)
    fig.update_xaxes(title=dict(text="PCS", font=dict(size=16, color=TEXT, family="Arial Black")), rangemode="tozero", tickfont=dict(size=15, color=TEXT, family="Arial Black"))
    fig.update_yaxes(automargin=True, tickfont=dict(size=15.5, color=TEXT, family="Arial Black"))
    return fig
...
with left:
    ...
    month_fig.add_bar(
        ...
        textposition="outside",
        textfont=dict(size=15, color=TEXT, family="Arial Black"),
    ...
    month_fig.add_bar(
        ...
        textposition="outside",
        textfont=dict(size=15, color=RED, family="Arial Black"),
    ...
    layout(month_fig, 455, dict(l=82, r=82, t=68, b=72))
    month_fig.update_layout(
        barmode="group",
        font=dict(family="Arial Black", size=16, color=TEXT),
        legend=dict(orientation="h", yanchor="bottom", y=1.05, xanchor="left", x=0, font=dict(size=15, color=TEXT, family="Arial Black")),
        yaxis=dict(title=dict(text="PCS", font=dict(size=16, color=TEXT, family="Arial Black")), gridcolor=GRID, tickfont=dict(size=15, color=TEXT, family="Arial Black")),
        yaxis2=dict(title=dict(text="%", font=dict(size=16, color=TEXT, family="Arial Black")), overlaying="y", side="right", ticksuffix="%", showgrid=False, rangemode="tozero", tickfont=dict(size=15, color=TEXT, family="Arial Black")),
    )
    month_fig.update_xaxes(tickfont=dict(size=15, color=TEXT, family="Arial Black"), tickangle=0)
